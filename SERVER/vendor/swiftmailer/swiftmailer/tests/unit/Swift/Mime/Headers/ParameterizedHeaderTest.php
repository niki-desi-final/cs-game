...
class Swift_Mime_Headers_ParameterizedHeaderTest extends \SwiftMailerTestCase {
	...
	public function testLongParamsAreBrokenIntoMultipleAttributeStrings() {
		...
		$encoder->shouldReceive ( 'encodeString' )->once ()->with ( $value, \Mockery::any (), 63, \Mockery::any () )->andReturn ( str_repeat ( 'a', 63 ) . "\r\n" . str_repeat ( 'a', 63 ) . "\r\n" . str_repeat ( 'a', 54 ) );
	...
	public function testEncodedParamDataIncludesCharsetAndLanguage() {
		...
		$encoder = $this->_getParameterEncoder ();
		$encoder->shouldReceive ( 'encodeString' )->once ()->with ( $value, 12, 62, \Mockery::any () )->andReturn ( str_repeat ( 'a', 20 ) . '%8F' . str_repeat ( 'a', 10 ) );
	...
	public function testMultipleEncodedParamLinesAreFormattedCorrectly() {
		...
		$encoder = $this->_getParameterEncoder ();
		$encoder->shouldReceive ( 'encodeString' )->once ()->with ( $value, 12, 62, \Mockery::any () )->andReturn ( str_repeat ( 'a', 20 ) . '%8F' . str_repeat ( 'a', 28 ) . "\r\n" . str_repeat ( 'a', 32 ) );
	...
	public function testValueAndParamCanBeEncodedIfNonAscii() {
		...
		$paramEncoder->shouldReceive ( 'encodeString' )->once ()->with ( $value, \Mockery::any (), \Mockery::any (), \Mockery::any () )->andReturn ( 'fo%8Fbar' );
