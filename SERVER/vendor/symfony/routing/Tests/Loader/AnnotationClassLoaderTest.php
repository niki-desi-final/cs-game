...
class AnnotationClassLoaderTest extends AbstractAnnotationLoaderTest {
	...
	public function testLoad($className, $routeData = array(), $methodArgs = array()) {
		...
		$this->assertCount ( count ( $defaults ), array_intersect_assoc ( $defaults, $route->getDefaults () ), '->load preserves defaults annotation and merges them with default arguments in method signature' );
