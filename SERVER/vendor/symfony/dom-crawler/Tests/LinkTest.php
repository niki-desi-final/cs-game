	...
	public function getGetUriTests() {
		return array (
            ...
            ',
				...
				array (
						'foo',
						'http://login.foo.com/bar/baz?/query/string',
						'http://login.foo.com/bar/foo' 
				),
