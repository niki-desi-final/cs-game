...
class ClassTest extends \PHPUnit_Framework_TestCase {
	...
	public function testExtendsImplements() {
		...
		$this->assertEquals ( new Stmt\Class_ ( 'SomeLogger', array (
	...
	public function testAbstract() {
		...
		$this->assertEquals ( new Stmt\Class_ ( 'Test', array (
	...
	public function testStatementOrder() {
		...
		$property = new Stmt\Property ( Stmt\Class_::MODIFIER_PUBLIC, array (
...
DOC;
		...
		$this->assertEquals ( new Stmt\Class_ ( 'Test', array (), array (
				'comments' => array (
	...
	public function testInvalidStmtError() {
		$this->createClassBuilder ( 'Test' )->addStmt ( new Stmt\Echo_ ( array () ) );
	}
	...
	public function testInvalidName() {
		$this->createClassBuilder ( 'Test' )->extend ( array (
				'Foo' 
		) );
	}
}
