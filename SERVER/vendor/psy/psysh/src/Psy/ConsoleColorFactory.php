...
class ConsoleColorFactory {
	...
	private function getDefaultConsoleColor() {
		...
		$color->addTheme ( Highlighter::LINE_NUMBER, array (
				'blue' 
		) );
	...
	private function getDisabledConsoleColor() {
		...
		$color->addTheme ( Highlighter::TOKEN_STRING, array (
				'none' 
		) );
		$color->addTheme ( Highlighter::TOKEN_COMMENT, array (
				'none' 
		) );
		$color->addTheme ( Highlighter::TOKEN_KEYWORD, array (
				'none' 
		) );
		$color->addTheme ( Highlighter::TOKEN_DEFAULT, array (
				'none' 
		) );
		$color->addTheme ( Highlighter::TOKEN_HTML, array (
				'none' 
		) );
		$color->addTheme ( Highlighter::ACTUAL_LINE_MARK, array (
				'none' 
		) );
		$color->addTheme ( Highlighter::LINE_NUMBER, array (
				'none' 
