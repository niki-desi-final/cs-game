...
class MethodTagTest extends \PHPUnit_Framework_TestCase {
	 ...
	 * @param bool $valid
	 *        	Whether the given signature is expected to
	 *        	be valid.
	 * @param string $expected_name
	 *        	The method name that is expected from this
	 *        	signature.
	 * @param string $expected_return
	 *        	The return type that is expected from this
	 *        	signature.
	 * @param bool $paramCount
	 *        	Number of parameters in the signature.
	 * @param string $description
	 *        	The short description mentioned in the
	 *        	signature.
	 *        	
