...
class PhoneNumber extends \Faker\Provider\PhoneNumber {
	 ...
	 * @param bool $ninth
	 *        	[def: false] If the number should have a nine in the beginning or not.
	...
	protected static function anyPhoneNumber($type, $formatted = true) {
		...
		$number = ($type == 'cellphone') ? static::cellphone ( $formatted, in_array ( $area, static::$ninthDigitAreaCodes ) ) : static::landline ( $formatted );
