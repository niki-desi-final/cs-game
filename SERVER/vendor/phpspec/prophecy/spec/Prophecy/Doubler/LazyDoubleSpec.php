...
class LazyDoubleSpec extends ObjectBehavior {
	 ...
	 */
	function it_returns_same_double_instance_if_called_2_times($doubler, $double1, $double2) {
	 ...
	 * @param \Prophecy\Prophecy\ProphecySubjectInterface $double        	
	 */
	function its_setParentClass_throws_exception_if_prophecy_is_already_created($doubler, $double) {
		$doubler->double ( null, array () )->willReturn ( $double );
	 ...
	 * @param \Prophecy\Prophecy\ProphecySubjectInterface $double        	
	 */
	function its_addInterface_throws_exception_if_prophecy_is_already_created($doubler, $double) {
		$doubler->double ( null, array () )->willReturn ( $double );
