...
class TransportManager extends Manager {
	...
	protected function createMailgunDriver() {
		...
		return new MailgunTransport ( new HttpClient ( Arr::get ( $config, 'guzzle', [ ] ) ), $config ['secret'], $config ['domain'] );
	}
	...
	protected function createMandrillDriver() {
		...
		return new MandrillTransport ( new HttpClient ( Arr::get ( $config, 'guzzle', [ ] ) ), $config ['secret'] );
	}
	...
	protected function createSparkPostDriver() {
		...
		return new SparkPostTransport ( new HttpClient ( Arr::get ( $config, 'guzzle', [ ] ) ), $config ['secret'] );
	}
