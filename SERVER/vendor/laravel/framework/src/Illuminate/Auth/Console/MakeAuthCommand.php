...
class MakeAuthCommand extends Command {
	...
	public function fire() {
		...
		if (! $this->option ( 'views' )) {
			...
			file_put_contents ( app_path ( 'Http/Controllers/HomeController.php' ), str_replace ( 'App\\', $this->laravel->getNamespace (), file_get_contents ( app_path ( 'Http/Controllers/HomeController.php' ) ) ) );
			
			$this->info ( 'Updated Routes File.' );
			
			file_put_contents ( app_path ( 'Http/routes.php' ), file_get_contents ( __DIR__ . '/stubs/make/routes.stub' ), FILE_APPEND );
		}
