...
class ContainerTest extends MockeryTestCase {
	...
	public function testNamedMockWithArrayDefs() {
		$m = $this->container->mock ( 'Foo', array (
				'foo' => 1,
				'bar' => 2 
		) );
		$this->assertEquals ( 1, $m->foo () );
	...
	public function testNamedMockMultipleInterfaces() {
		$m = $this->container->mock ( 'stdClass, ArrayAccess, Countable', array (
				'foo' => 1,
				'bar' => 2 
		) );
		$this->assertEquals ( 1, $m->foo () );
	...
	public function testNamedMockWithConstructorArgs() {
		$m = $this->container->mock ( "MockeryTest_ClassConstructor2[foo]", array (
				$param1 = new stdClass () 
		) );
	...
	public function testNamedMockWithConstructorArgsButNoQuickDefsShouldLeaveConstructorIntact() {
		$m = $this->container->mock ( "MockeryTest_ClassConstructor2", array (
				$param1 = new stdClass () 
		) );
	...
	public function testBlockForwardingToPartialObject() {
		$m = $this->container->mock ( new MockeryTestBar1 (), array (
				'foo' => 1,
	...
	public function testSplfileinfoClassMockPassesUserExpectations() {
		$file = $this->container->mock ( 'SplFileInfo[getFilename,getPathname,getExtension,getMTime]', array (
				__FILE__ 
		) );
	...
	public function testMockeryShouldDistinguishBetweenConstructorParamsAndClosures() {
		...
		$mock = $this->container->mock ( 'MockeryTest_ClassMultipleConstructorParams[dave]', array (
				&$obj,
				'foo' 
		) );
	}
